...
class RoomCountersData {
  ...
  static RoomCounters getById(int roomCountersId) {
    return RoomCounters.fromMap(RoomCountersData.roomCountersList[roomCountersId]);
  }

  static List<RoomCounters> getRoomCountersList() {
    return RoomCountersData.roomCountersList.values.map((e) => RoomCounters.fromMap(e)).toList();
  }
}
