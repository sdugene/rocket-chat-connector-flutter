...
class ChannelCountersData {
  ...
  static ChannelCounters getById(int channelCountersId) {
    return ChannelCounters.fromMap(ChannelCountersData.channelCountersList[channelCountersId]);
  }

  static List<ChannelCounters> getChannelCountersList() {
    return ChannelCountersData.channelCountersList.values.map((e) => ChannelCounters.fromMap(e)).toList();
  }
}
